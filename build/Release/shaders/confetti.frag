...
void main()
{
    if (u_confetti == 1) {
        ...
        vec2 fragCoord = o_vertex_uv * iResolution;
        ...
        // FIXME: when light mode on confetties are lookin bad!
    
        result_frag_color = texture(u_texture, o_vertex_uv) + col;
    } else {
