...
{
    vec2 result = (pos * 2) / (u_window_size) - 1;
...
void main()
{
    ...
    //gl_Position = vec4(i_position, 1.0);//vec4(position, 1.0, 1.0);// TODO: i_position.z as z component...
    gl_Position = vec4(position, i_position.z, 1.0);//vec4(position, 1.0, 1.0);// TODO: i_position.z as z component...
